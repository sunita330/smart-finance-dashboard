    ...
    <nav className="navbar">
      ...
      <div style={{ display:"flex", alignItems:"center", gap:12, flexShrink:0 }}>
        <div style={{
          ...
          boxShadow:"0 4px 14px rgba(109,140,255,0.45)",
        }}>💹</div>
        <div>
          <span className="grad-text" style={{ fontSize:17, fontWeight:800, letterSpacing:"-0.03em" }}>
            FinanceOS
          </span>
          <span style={{ fontSize:10, color:"var(--text-muted)", marginLeft:7, fontWeight:600, letterSpacing:"0.06em" }}>
            PREMIUM
          </span>
        </div>
      </div>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:10, flexShrink:0 }}>
        {/* Theme toggle */}
        <button onClick={toggle} className="btn btn-ghost" style={{ display:"flex", alignItems:"center", gap:6, padding:"7px 14px" }}>
